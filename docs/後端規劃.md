...
**後端版本**：v1.0.0
**最後更新**：2024-11-27
**狀態**：骨架完成，待實作 Controller/Service/Repository
...
- **MySQL Connector/J** - 資料庫驅動

### 輔助工具
- **Lombok** - 減少樣板代碼
- **BCrypt** - 密碼加密（Spring Security 內建）
- **JWT (jjwt 0.11.5)** - Token 認證
- **Validation API** - 參數驗證（Jakarta Validation）
- **MapStruct** - DTO 轉換（選用）
